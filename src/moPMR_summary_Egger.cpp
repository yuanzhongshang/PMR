...
void molmm_pxem_ptr2_summary(const arma::vec& betaxh, const arma::mat& Sigma1,  const int& n1, const int& maxIter,
  ...
  for (int iter = 1; iter < maxIter; iter ++ ) {
    ...
    void mologlike_twas(const arma::mat& R, const arma::vec& res_betaxh, const arma::vec& res_betayh, const arma::vec& mu, const double& sigma2z, const double& sigma2x,
    ...
    molmm_pxem_ptr2_summary(betaxh, Sigma1, n1, maxIter, sigma2x, sigma2z, loglik0, iter0, Sigb, mub);
    ...
    mologlike_twas(R, res_betaxh, res_betayh, mu, sigma2z, sigma2x, eVal, n1 , n2, p, loglik(iter - 1));
